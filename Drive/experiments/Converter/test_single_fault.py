...
save_folder = os.path.join(save_path, '1_phases_lost/perf_boost_01_16_22_49_04')
params = torch.load(os.path.join(save_folder, 'best_controller_params_epoch_2450.pth'),weights_only=False)
